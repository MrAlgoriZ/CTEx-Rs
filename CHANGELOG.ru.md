...
31-05-2026:
  - Конфигурация разделена на 2 файла

1-06-2026:
  - Добавлен тест для нахождения лучшей конфигурации модели
  - Логирование в файл добавлено
  - Проект полностью переведен на английский

5-06-2026:
  - Добавлена поддержка файловых путей с помощью std::path

6-06-2026:
  - Акторы распределены между файлами

10-06-2026:
  - Result<\*, anyhow::Error> заменен на anyhow::Result<\*>
